...
return (
  <>
    <header classNa="page-header">
      <h1>Johanna Falkenmark</h1>
      <div classNam="icons-on-header">
        <a
          target="self"
      ...
      <menu classNam="navigation-menu">
        <input type="checkbox" id="check" classNam="hamburger-checkbox" />
